(function ($) {
    "use strict";
    if ($("#pendapatan_perbulan_chart").length) {
        const ctx = document.getElementById("pendapatan_perbulan_chart");
        const pendapatanChart = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: "Total Pendapatan GOR Tahun Ini",
                    },
                },
                scales: {
                    y: {
    ...
    if ($("#visit-reservation-weekly").length) {
        const ctx = document.getElementById("visit-reservation-weekly");
        const reservasiChart = new Chart(ctx, {
                ...
                datasets: [
                    {
                        ...
                        data: dataReservasiMingguan, // <-- ganti pakai data dari controller jika perlu
                        fill: false,
                        borderColor: "#4B49AC",
                        tension: 0.4,
                    },
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: "Grafik Jumlah Reservasi per Hari",
                    },
                },
                scales: {
                    y: {
